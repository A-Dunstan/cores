...
FLASHMEM void configure_external_ram()
{
	...
	// CLK_SEL: 0 -> 396; 1 -> 720; 2 -> 664.62; 3 -> 528; PODF(n) -> /(n+1)
	CCM_CBCMR = (CCM_CBCMR & ~(CCM_CBCMR_FLEXSPI2_PODF_MASK | CCM_CBCMR_FLEXSPI2_CLK_SEL_MASK))
		//| CCM_CBCMR_FLEXSPI2_PODF(7) | CCM_CBCMR_FLEXSPI2_CLK_SEL(0); // 49.5 MHz - slowest possible
...
#define LIMIT_PREFETCH_SIZE		
	...
	// [no] pre-fetch, high priority, MSTRID 0xF, size 0xFF	
	// MSTRID (27.1.1):	0 = core, 1 = eDMA, 2 = DCP, 3 = other
...
#if defined(LIMIT_PREFETCH_SIZE)
	// pre-fetch, high priority, MSTRID 0xF, size 0xFF	
	// MSTRID (27.1.1):	0 = core, 1 = eDMA, 2 = DCP, 3 = other
	uint32_t mask = (FLEXSPI_AHBRXBUFCR0_PREFETCHEN | FLEXSPI_AHBRXBUFCR0_PRIORITY_MASK
		| FLEXSPI_AHBRXBUFCR0_MSTRID_MASK | FLEXSPI_AHBRXBUFCR0_BUFSZ_MASK);
